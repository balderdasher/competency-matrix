 ...
 */
public class HoldableSingleton {
    private HoldableSingleton() {
    }

    private static class InstanceHolder {
        private static final HoldableSingleton INSTANCE = new HoldableSingleton();
    }

    public static final HoldableSingleton getInstance() {
